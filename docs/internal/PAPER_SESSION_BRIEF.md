...
- **sha256 = `ac297f4559461914a9c273ad230a9564937e4038997cc390a0cc359325d51f27`** (record this in the methods section as the pre-registration hash; equivalent to a CT.gov registration before enrollment)
...
| Methods §4 | "Pre-registered random sample of 200 trials, stratified by Branch and DiseaseCategory, sha256 `ac297f45…`" | `validation_study/sample_v1.json` |
