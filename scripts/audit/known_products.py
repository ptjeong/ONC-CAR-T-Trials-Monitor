...
KNOWN_PRODUCTS = [
    ...
    {'aliases': ['varnimcabtagene autoleucel', 'qartemi'],
     'target': 'CD19', 'branch': 'Heme-onc', 'product_type': 'Autologous',
     'notes': 'Immuneel. India / Spain B-NHL approval 2025.'},
    {'aliases': ['renikeolunsai', 'hicara'],
     'target': 'CD19', 'branch': 'Heme-onc', 'product_type': 'Autologous',
     'notes': 'Hrain Bio. China r/r LBCL approval 2025.'},
    {'aliases': ['pulkilumab', 'pulidekai'],
     'target': 'CD19', 'branch': 'Heme-onc', 'product_type': 'Autologous',
     'notes': 'Chongqing Precision. China ALL approval 2025.'},
    {'aliases': ['anbal-cel', 'anbalcel', 'anbalcabtagene autoleucel'],
     'target': 'CD19', 'branch': 'Heme-onc', 'product_type': 'Autologous',
     'notes': 'Curocell. South Korea pre-reg.'},
    {'aliases': ['kite-753', 'kite753'],
     'target': 'CD19', 'branch': 'Heme-onc', 'product_type': 'Autologous',
     'notes': 'Kite/Gilead. DLBCL (RMAT designation Q1 2026).'},
    {'aliases': ['nxc-201', 'nxc201'],
     'target': 'BCMA', 'branch': 'Heme-onc', 'product_type': 'Autologous',
     'notes': 'Immix Biopharma. AL amyloidosis (BTD Q1 2026).'},
    {'aliases': ['wu-cart-007', 'wucart-007', 'wucart007', 'wu-cart007'],
     'target': 'CD7', 'branch': 'Heme-onc', 'product_type': 'Allogeneic/Off-the-shelf',
     'notes': 'Wugen. Allogeneic CD7 CAR-T for ALL (BTD Q1 2026).'},
]
